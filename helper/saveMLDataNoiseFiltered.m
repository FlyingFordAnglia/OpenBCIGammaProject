...
if ~exist(fileName,'file')
    ...
    folderName    = fullfile(folderDestinationString,'data',[subjectName 'NoiseFiltered'],gridType,expDate,protocolName);
...
for i=1:numTrials
    ...
    allStimulusIndex = cat(2,allStimulusIndex,1:length(cN));  % vidya: what is this?
    allTrialNumbers = cat(2,allTrialNumbers,zeros(1,length(cN))+i); % vidya: what is this?
end
