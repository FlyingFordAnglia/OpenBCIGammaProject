...
function [digitalTimeStamps,digitalEvents]=extractDigitalDataBrainProductsNoiseFiltered(subjectName,expDate,protocolName,folderSourceString,gridType,deltaLimitMS)
