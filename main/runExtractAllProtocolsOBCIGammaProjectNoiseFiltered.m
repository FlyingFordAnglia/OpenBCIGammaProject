% This program is identical to runExtractAllProtocolsOBCIGammaProject.m
% except for the file paths and mains noise filtering.
clear;
gridType='EEG'; 
...
extractTheseIndices = 1:68; % choose required protocol numbers from allProtocolsOBCIGammaProject;
for iProt = 1:length(extractTheseIndices)
    ...
    if strcmpi(protocolName,'GRF_004') || strcmpi(protocolName,'GRF_005')
        ...
        %TODO: noise removal function separately
